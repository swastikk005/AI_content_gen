            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {plans.map((plan, index) => (
                    ...
                    >
                        ...
                        <Link
                            href="/login"
                            className={`w-full py-3 rounded-xl font-bold transition-all text-center ${plan.popular ? 'bg-primary text-white hover:bg-primary/90' : 'bg-white/5 text-white hover:bg-white/10'}`}
                        >
                            {plan.button}
                        </Link>
                    </div>
